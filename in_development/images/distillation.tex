...
\begin{tikzpicture}
  ...
  % condensor
  \draw [thick,fill=blue!30] (2,7) arc (240:300:2cm) -- ++(0,0.4) arc (60:120:2cm) -- ++(0,-0.4);
  \draw (3,7.2) node {\small Condenser};
  ...
  % reboiler
  \draw [thick,fill=red!30] (2.0,0.6) arc (240:300:2cm) -- ++(0,0.4) arc (60:120:2cm) -- ++(0,-0.4);
  \draw (3,0.8) node {\small Reboiler};
  \draw [->,thick] (2.25,1.13) -- ++(0,0.74) node[midway,left] {$V', y_{N+1}$};
  \draw [<-,thick] (3.75,1.13) -- ++(0,0.74) node[midway,right] {$L', x_N$};
  \draw [->,thick] (4,0.8) -- ++(0.75,0) node [right] {$B, x_B$};
